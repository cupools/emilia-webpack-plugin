    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('normal-module-factory', function (nmf) {
        nmf.plugin('before-resolve', function (data, callback) {
          ...
          if (mark) {
            var buf = Buffer.from('iVBORw0KGgoAAAANSUhEUgAAAB0AAAAcBAMAAABv4amZAAAAGFBMVEUAAAD86Fj86Fj86Fj86Fj86Fj86Fj86FgF5RrBAAAAB3RSTlMAWofdpe+PVNsiFgAAAB1JREFUGNNjEC9HBg4Dwi81hoEEML+IAQ5G+fj5AAqDW9eAaVTQAAAAAElFTkSuQmCC', 'base64');
            var p = _path2.default.join(__dirname, '../.extract', mark + '.png');
            _fs2.default.writeFileSync(p, buf, 'binary');
          }
